                ...
                <div className="mb-4">
                  ...
                  <Select value={formData.school} onValueChange={handleSchoolChange}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Anura Madhya Maha Vidyalaya, Yakkala">Anura Madhya Maha Vidyalaya, Yakkala</SelectItem>
                      ...
                      <SelectItem value="Gateway College Colombo">Gateway College Colombo</SelectItem>
                      <SelectItem value="Gateway College Dehiwala">Gateway College Dehiwala</SelectItem>
                      ...
                      <SelectItem value="Highlands College, Maharagama">Highlands College, Maharagama</SelectItem>
                      <SelectItem value="Hilburn International School, Avissawella">Hilburn International School, Avissawella</SelectItem>
                      <SelectItem value="Hindu Ladies College, Colombo">Hindu Ladies College, Colombo</SelectItem>
                      ...
                      <SelectItem value="Jeelan Central College, Pandura">Jeelan Central College, Pandura</SelectItem>
                      <SelectItem value="K Kingston College International, Wellawatta"> Kingston College International, Wellawatta</SelectItem>
